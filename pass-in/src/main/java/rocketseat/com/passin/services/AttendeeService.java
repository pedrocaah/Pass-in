...
public class AttendeeService {
    ...
    public void verifyAttendeeSubscription(String email, String eventId){
        Optional<Attendee> isAttendeeRegristred =  this.attendeeRepository.findByEventIdAndEmail(eventId, email);
        if (isAttendeeRegristred.isPresent()) throw new AttendeeAlreadyExistException("Attendee is already registred");
    }
